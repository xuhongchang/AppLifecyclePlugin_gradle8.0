package com.hm.iou.lifecycle.plugin;
  ...
  object GlobalConfig {
    ...
    const val REGISTER_CLASS_FILE_NAME = "com/hm/lifecycle/api/ApplicationLifecycleManager.class"

    const val INJECT_CLASS_NAME = "com/hm/lifecycle/api/ApplicationLifecycleManager"
